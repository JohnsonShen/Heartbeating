 ...
 * @param       None
 * @return      None
 * @details     This funcction is use to get LR value and branch to Hard_Fault_Handler function.
 */
 ...
 * @param       None
 * @return      None
 * @details     This funcction is use to get stack pointer value and branch to Get_LR_and_Branch function.
 */
...
int kbnumbers(void)
{
	return ((DEBUG_PORT->FIFOSTS>>8)&0x3f);  
}
